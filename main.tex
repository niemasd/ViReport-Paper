...
\title[ViReport]{ViReport: an automated pipeline for viral phylogenetic and epidemiological analysis}
\author[Moshiri \textit{et~al}.]{Niema Moshiri\,$^{\text{\sfb 1,}*}$,
Jonathan Pekar\,$^{\text{\sfb 2}}$,
Kim Almaraz\,$^{\text{\sfb 1}}$,
Tyler Jang\,$^{\text{\sfb 1}}$,
McKenna Lewis\,$^{\text{\sfb 1}}$,
Titan Ngo\,$^{\text{\sfb 1}}$,
Miranda Song\,$^{\text{\sfb 1}}$, and
Joel O. Wertheim\,$^{\text{\sfb 3}}$}
\address{$^{\text{\sf 1}}$Department of Computer Science \& Engineering, UC San Diego, La Jolla, 92093, USA.\\
$^{\text{\sf 2}}$Bioinformatics and Systems Biology Graduate Program, UC San Diego, La Jolla, 92093, USA.\\
$^{\text{\sf 3}}$Department of Medicine, UC San Diego, La Jolla, 92093, USA.}
...
\textbf{Contact:} \href{a1moshir@ucsd.edu}{a1moshir@ucsd.edu}\\
